...
if (isset($_COOKIE['login']))
{
  ...
  echo "<tr>
        <td class='register'>
        <p class='auto_t'>Ласкаво просимо</p> <p class='cookie'>".$_COOKIE['login']."</p><div class='reg'><form method='post' action='exit.php'>
      <input type='submit' name='submit' value='Вихід'>
      </form><br>
  <button><a href='user_room.php' class='register_url'>Кімната користувача</a></button></div>
        </td>
        </tr>";
...
<td class="register">
    ...
    <div class="reg">
      ...
      <br>
      <button><a href="for_register.php" class="register_url">Реєстрація</a></button>
    </div>
      </td>
  </tr>';
}
